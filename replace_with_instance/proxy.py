...
class MyDialogs(gui.GeDialog):
    ...
    def GetInExcludeList(self, param_id):
        gui = self.FindCustomGui(param_id, c4d.CUSTOMGUI_INEXCLUDE_LIST)
        if gui:
            return gui.GetData()
        return None
    def AddInExcludeList(self, param_id, flags, link=None):
        gui = self.AddCustomGui(param_id, c4d.CUSTOMGUI_INEXCLUDE_LIST, "", flags, 400, 0)
        gui.SetData(link)
        return gui
    ...
    def CreateLayout(self):
        ...
        self.AddStaticText(1020, c4d.BFH_LEFT, 150, 0, "Test", c4d.BORDER_NONE)
        self.AddInExcludeList(1021, c4d.BFH_LEFT) # InEx
        ...
        self.AddChild(1010, 1, "Target Object")
        self.AddChild(1010, 2, "Reference Object")
        ...
        if id == 1100:
            ...
            if base != None:
                ...
                for i, obj in enumerate(objects):
                    ...
                    instance[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_X] = obj[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_X]
                    instance[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_Y] = obj[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_Y]
                    instance[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_Z] = obj[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_Z]
                    instance[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_X] = obj[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_X]
                    instance[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_Y] = obj[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_Y]
                    instance[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_Z] = obj[c4d.ID_BASEOBJECT_REL_SCALE,c4d.VECTOR_Z]
                    instance[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_X] = obj[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_X]
                    instance[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_Y] = obj[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_Y]
                    instance[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_Z] = obj[c4d.ID_BASEOBJECT_REL_ROTATION,c4d.VECTOR_Z]
